  ...
  return (
    ...
    "
      ...
      <div className="pb-20 md:pb-0">
        ...
        <div className='my-15 mx-4 md:mx-10 lg:mx-12'>
          <div className='flex flex-col gap-4 tracking-widest mt-6'><h1 className='text-2xl font-medium bg-amber-50 px-1 w-fit '>Our Research</h1>
